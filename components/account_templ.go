...
func AccountBar(username string) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<nav class=\"bg-white border-gray-200 dark:bg-gray-900\"><div class=\"flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4\"><a href=\"#\" class=\"flex items-center space-x-3 rtl:space-x-reverse\"><span class=\"self-center text-2xl whitespace-nowrap\">Hello, </span> <span class=\"self-center text-2xl font-semibold whitespace-nowrap dark:text-white\">")
